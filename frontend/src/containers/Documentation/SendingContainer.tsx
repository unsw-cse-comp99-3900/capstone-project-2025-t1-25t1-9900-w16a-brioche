...
const Sending: React.FC = () => {
  return (
    <section id="sending" className="mb-16">
      ...
      <ul className="mt-2 list-disc pl-5 text-secondary-700">
        <li>
          Transmits the UBL XML invoice directly to the recipient's PEPPOL
          access point
        </li>
      ...
      <div className="mt-4 bg-secondary-50 rounded-lg p-4">
        ...
        <ul className="mt-2 text-sm list-disc pl-5 text-secondary-700">
          ...
          <li>
            Document type identifier (for invoices:
            urn:oasis:names:specification:ubl:schema:xsd:Invoice-2)
          </li>
          <li>
            Process identifier (for invoices:
            urn:fdc:peppol.eu:2017:poacc:billing:01:1.0)
          </li>
        </ul>
        <p className="mt-2 text-sm text-secondary-700">
          Our platform can look up the recipient's PEPPOL details using their
          ABN.
        </p>
      </div>
    </section>
